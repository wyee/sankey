...
// Create the chart
    let map = Highcharts.mapChart('map', {
        ...
        title: {
            text: 'Ninth Grade to Postsecondary Award'
        },
                    ...
                    events: {
                        ...
                        click: function () {
                            ...
                            sankeyChart.update({
                                ...
                                series: [{
                                    // data: sankeyData(this.series.name)
                                    // data: data['default']
                                }]
                            })
                        },
        ...
        series: [
            {
                name: 'Group 1',
                data: ['us-ca-015', 'us-ca-023', 'us-ca-045', 'us-ca-033', 'us-ca-097', 'us-ca-041',
                    'us-ca-055', 'us-ca-095', 'us-ca-013', 'us-ca-001', 'us-ca-075', 'us-ca-081', 'us-ca-085',
                ].map(code => ({
                    code
                }))
            }, {
